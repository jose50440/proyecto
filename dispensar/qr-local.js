(function() {
        ...
        // ImplementaciÃ³n ligera de QR Code usando qrcode-generator
        // Basado en qrcode-generator (https://github.com/kazuhikoarase/qrcode-generator)
        // VersiÃ³n minificada y adaptada para funcionar offline
        
        // Tabla de generaciÃ³n de polinomios para correcciÃ³n de errores
        const QR_MATH = {
            glog: function(n) {
        ...
        if (typeof window !== 'undefined') {
            ...
            // FunciÃ³n principal para generar QR como DataURL
            window.QRCode.toDataURL = function(text, opts, cb) {
                ...
                try {
                    ...
                    // Mapear nivel de correcciÃ³n de errores
                    ...
                    // Calcular tipo de QR automÃ¡ticamente si no se especifica
                    let qrType = typeNumber;
                    if (qrType === 0) {
                        // Calcular tipo mÃ­nimo necesario
            ...
            console.log('âœ… QRCode library local cargada correctamente (offline)');
        }
    })();